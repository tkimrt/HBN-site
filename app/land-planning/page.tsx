...
const engagements = [["Land plan review", "Expert recommendations before the layout is locked."], ["Full TINS engagement", "From raw site through product, pricing, and elevation strategy."], ["Lot premium optimization", "A defensible premium schedule for lots already on the ground."], ["Product lineup development", "A four-step path from envisioned lineup to purpose-built plans."]];

export default function LandPlanningPage() {
  return <PageShell>
    <SubpageHero eyebrow="Land planning" title="The land plan is where profits are made—or lost." intro="Totally Integrated Neighborhood Solutions treats the land plan, product lineup, and pricing as one system, because that is how buyers experience them." image="/images/neighborhood-aerial.jpg" imageAlt="Aerial view of a planned residential community" tone="green" />
